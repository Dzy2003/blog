...
//        );
    ...
    /**
     * 设置articleVo的likes属性
     * @param articleVo articleVo对象
     */
    private void setArticleVoLikes(ArticleVo articleVo) {
        articleVo.setLikes(stringRedisTemplate.opsForZSet().count(BLOG_LIKED_KEY + articleVo.getId()
